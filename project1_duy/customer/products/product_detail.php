    ...
    <header class="p-4 bg-primary text-white">
        <div class="container">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="/project1/customer/home.php"
                    class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
                    <img class="img-fluid rounded-circle" src="/project1/img/logo.png" alt="Example Image" width="150"
                        class="me-2" />
                </a>
                <!-- LOGO END -->
                ...
                <div class="text-end d-flex">
                    ...
                    <button type="button" class="btn btn-outline-light">
                        ...
                        <?php
                        //NẾu tồn tại thì sẽ in ra email khách hàng 
