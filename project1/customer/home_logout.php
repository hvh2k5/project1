...
<head>
  ...
  <style>
    ...
    .zoom {
      ...
      /* Hiệu ứng thay đổi trong 0.2 giây */
    }

    .zoom:hover {
      transform: scale(1.05);
      /* Kích thước tăng lên 1.05 lần khi di chuột vào */
    }
  </style>
  ...
  <header class="p-4 bg-primary text-white">
    <div class="container">
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/project1/customer/home_logout.php" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
          <img class="img-fluid" src="/project1/img/logo.png" alt="Example Image" width="150" height="150" class="me-2" />
        </a>
        <!-- LOGO END -->
        ...
        <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
          <input name="search" class="form-control form-control-dark" placeholder="Search..." aria-label="Search">
        </form>
        ...
        <div class="text-end d-flex">
          ...
          <!-- Đăng Nhập -->
          <form method="POST" action="/project1/customer/auth/login.php" class="me-2">
  ...
  <main class="container">
    ...
    <div class="row row-cols-4 g-4">
      ...
      while ($row = mysqli_fetch_assoc($rs)) {
        ...
        <div class="col">
          <div class="card">
            <img class="zoom" src="<?php echo $row['image']; ?>" class="card-img-top" alt="<?php echo $row['name']; ?>">
            <div class="card-body">
              <h5 class="card-title"><?php echo $row['name']; ?></h5>
              <p class="card-text">Giá:<?php echo $row['buy_price']; ?></p>
            </div>
          </div>
        </div>
        <?php
