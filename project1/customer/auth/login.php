...
<form method="POST" action="/project1/customer/home_logout.php">
     <button  name="submit" class="btn btn-danger"><-</button>
</form>

    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6 rounded-form">
                <b class="text-center">Xin chào,<br>   
                    đăng nhập để mua hàng tại D&H Store</b>
                <form method="POST" action="/project1/customer/auth/login_process.php">
                    ...
                    <div class="text-center">
                        <button name="submit" class="btn btn-danger">Đăng Nhập</button>
                    </div>
