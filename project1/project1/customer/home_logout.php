  ...
  <header class="p-4 bg-primary text-white">
    <div class="container">
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/project1/customer/home_logout.php"
          class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
          <img class="img-fluid" src="/project1/img/logo.png" alt="Example Image" width="150" height="150"
            class="me-2" />
        </a>
        <!-- LOGO END -->
      ...
      <div class="row my-3 row-cols-4">
        <?php while ($row = mysqli_fetch_assoc($rs)): ?>
          <div class="col my-3 zoom-img">
            ...
            <a href="/project1/customer/products/product_detail_logout.php?id=<?php echo $row['id']; ?>">
